    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Main navigation">
        <div class="flex items-center justify-between h-24 py-3">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-3 group flex-shrink-0" aria-label="Custom Premium Boxes Home">
                ...
                @endphp
                @if($navigationLogo)
                    <img src="{{ asset('storage/' . $navigationLogo) }}" alt="Custom Premium Boxes" class="h-20 w-auto transition-transform duration-300 group-hover:scale-110" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex'; this.nextElementSibling.nextElementSibling.style.display='flex';">
                    ...
                    <div class="flex flex-col leading-tight hidden">
        ...
        <div class="sticky top-0 bg-light border-b border-light-muted z-10">
            <div class="flex items-center justify-between px-4 sm:px-6 py-4">
                ...
                <a href="{{ route('home') }}" class="flex items-center space-x-3" id="mobile-menu-logo-link">
                    ...
                    @endphp
                    @if($navigationLogo)
                        <img src="{{ asset('storage/' . $navigationLogo) }}" alt="Custom Premium Boxes" class="h-16 w-auto" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex'; this.nextElementSibling.nextElementSibling.style.display='flex';">
